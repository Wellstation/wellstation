              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-white/10 border border-white/20 p-4 rounded-xl text-white placeholder-white/50 focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 backdrop-blur-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  />
          ...
          {result && (
            <div className={`mt-6 p-4 rounded-xl backdrop-blur-sm ${result === "success"
              ...
              <div className="flex items-center justify-between">
                ...
                {result === "success" && (
                  <a
                    href="/reservations/repair/search"
