...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-between bg-white dark:bg-black px-4 py-6">
      ...
      {/* 버튼 그룹 */}
      <main className="flex flex-col items-center gap-4 w-full max-w-xs">
        <Link href="/reserve/repair">
          <button className="w-full px-6 py-4 text-lg font-semibold text-white rounded-2xl shadow-xl
