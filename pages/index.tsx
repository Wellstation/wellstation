...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col justify-between bg-white dark:bg-black px-4 py-6">
      ...
      {/* 상단 로고 */}
      <header className="flex justify-center mb-1">
        <Image src="/logo1.svg" alt="로고" width={250} height={110} />
      </header>

      {/* 버튼 그룹 */}
      <main className="flex flex-col items-center gap-150">
      ...
      {/* 하단 푸터 */}
      <footer className="mt-1 text-center text-sm text-gray-700 leading-[0.15] space-y-0.05">
        <p>신흥모터스 & 앱스 대표 : 박경남 | 주소 : 부산광역시 강서구 대저중앙로 383-1</p>
        <p>사업자등록번호 : 859-37-01635 | 호스팅서비스사업자 : Vercel Inc.</p>
        <p>이메일 : <a href="mailto:apsauto@naver.com" className="text-blue-600">apsauto@naver.com</a> | 고객센터 : <a href="tel:16684590" className="text-blue-600">1668-4590</a></p>
      </footer>
    </div>
  );
}
